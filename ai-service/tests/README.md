...
│                     # deterministic grounding — and generation (C30b) — versioned prompt,
│                     # the three checks, the single repair, degradation. Agent loops later
