...
namespace JoiabagurPV.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260831222840_AddVerdictSubjectPopulation")]
    partial class AddVerdictSubjectPopulation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JoiabagurPV.Domain.Entities.ProductFamily", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JoiabagurPV.Domain.Entities.ProductFamilyMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProductFamilyId", "SortOrder")
                        .IsUnique();

                    b.HasIndex("ProductFamilyId", "VariantLabel")
                        .IsUnique();

                    b.ToTable("ProductFamilyMembers", (string)null);
                });
