...
- [ ] **Dos declaraciones más** *(añadido el 2026-09-13, al partir C30; **matizado el 2026-09-22, al implementar C36**)*: la **pregunta libre sin pieza no tiene pantalla** (§15.12) y la **abstención se aplica sin clasificar intención** hasta que llegue el enrutador (§15.13). Las dos están acotadas y con su solución identificada, que es lo que el rubro premia frente a un hueco callado. **C36 mueve la primera a medias y no cierra ninguna**: dos de los tres modos ya llegan al operario en la ficha de venta, y el tercero no; el rechazo cortés del enrutador sigue sin superficie, porque su clasificador sólo corre en el modo que no tiene pantalla
- [ ] **Una declaración más** *(añadido el 2026-09-22, al implementar C36)*: **la ficha de venta no tiene telemetría** (§15.14). Abrirla, preguntar y elegir variante no dejan rastro, así que su uso no es medible y la condición de reactivación de la tarea diferida de `generate=false` no es observable con datos
