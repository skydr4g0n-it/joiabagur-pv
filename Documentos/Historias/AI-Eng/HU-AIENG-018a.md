...
- **Librería de agrupamiento en Python**, determinista, sin LLM y sin llamadas de red, en `ai-service/src/jbg_ai/families/`:
  ...
  - **vocabulario cerrado de materiales declarado en Python con test de fijación**, aceptando la duplicación con [`materials-vocabulary.ts`](../../../frontend/src/lib/materials-vocabulary.ts) como deuda anotada;
...
| **D12** | **Vocabulario de materiales declarado en Python con test de fijación**, duplicando el de [`materials-vocabulary.ts`](../../../frontend/src/lib/materials-vocabulary.ts) | Cruzar la frontera para compartir un fichero del frontend sería peor que la duplicación. La deuda queda anotada y el test de fijación hace ruidosa cualquier divergencia futura |
...
3. **Vocabulario cerrado de materiales en Python con test de fijación** (D12), y anotación de la deuda de duplicación con `materials-vocabulary.ts` del frontend.
