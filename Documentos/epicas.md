...
- Guardrails, enrutado de intención y pregunta de aclaración ante consultas ambiguas. Hasta que llegue el enrutador, la capa de generación **no redacta cuando el catálogo no puede contestar** — es una red, no un clasificador, y la diferencia se declara
...
**Changes asociados:** **C26** (`add-substitutes-retrieval` — **archivado el 2026-09-12**, 62/62), ~~C27~~ (**cortado**), **C30a**, **C30b**, C31, C32, C34, C36
...
| **EP15** | Venta Asistida, Sustitutos y Agentes | **C26 (archivado)**, ~~C27~~ *(cortado 12 sep)*, **C30a (archivado 13 sep)**, **C30b (archivado 14 sep)** *(partidos el 13 sep)*, C31, C32, C34, C36 | 🟠 parcial |
