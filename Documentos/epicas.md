...
**Changes asociados:** C12 (hecho), C13 (hecho), C14 (hecho), C15 (hecho), C16 (hecho), C20 (hecho), C21 (hecho), **C22 (hecho)**, **C25** (`recalibrate-ranking-and-abstention` — **en curso**, abierto el 2026-09-11; renombrado desde `add-business-signals-ranking`)
