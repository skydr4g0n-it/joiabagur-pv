...
- **Toda cifra de precio o stock se emite como placeholder** que resuelve .NET; si alguno queda sin resolver, la respuesta se rechaza. **Y el flanco simétrico también se cierra** *(13 sep)*: un argumentario que escriba «39,90 €» literal no deja placeholder alguno y pasaría ese rechazo, así que el servicio de IA admite **sólo cifras presentes en el material que se le entregó** —tallas, milímetros, `925`, dígitos de SKU—, en ejecución y no sólo en evaluación
...
**Changes asociados:** **C26** (`add-substitutes-retrieval` — **archivado el 2026-09-12**, 62/62), ~~C27~~ (**cortado**), **C30a**, **C30b**, **C31** *(archivado el 16 sep)*, **C32a** *(archivado el 20 sep)*, **C32b** *(archivado el 21 sep)* *(partidos el 20 sep)*, C34, C36
...
| **EP15** | Venta Asistida, Sustitutos y Agentes | **C26 (archivado)**, ~~C27~~ *(cortado 12 sep)*, **C30a (archivado 13 sep)**, **C30b (archivado 14 sep)** *(partidos el 13 sep)*, **C31 (archivado 16 sep)**, **C32a (archivado 20 sep)**, **C32b (archivado 21 sep)** *(partidos el 20 sep)*, C34, C36 | 🟠 parcial |
...
| **TOTAL PF** | | **45 fichas · 39 vivas** (5 anuladas, 1 cortada) — **34 archivadas, 5 pendientes** | |
