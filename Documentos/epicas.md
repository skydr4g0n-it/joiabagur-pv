...
| **EP15** | Venta Asistida, Sustitutos y Agentes | **C26 (archivado)**, ~~C27~~ *(cortado 12 sep)*, **C30a (implementado 13 sep, sin archivar)**, **C30b** *(partidos el 13 sep)*, C31, C32, C34, C36 | 🟠 parcial |
...
| **TOTAL PF** | | **44 fichas · 38 vivas** (5 anuladas, 1 cortada) — **30 archivadas, 8 pendientes** | |
