...
**Changes asociados:** **C26** (`add-substitutes-retrieval` — **archivado el 2026-09-12**, 62/62), ~~C27~~ (**cortado**), **C30a**, **C30b**, **C31** *(archivado el 16 sep)*, **C32a** *(en curso, 20 sep)*, **C32b** *(partidos el 20 sep)*, C34, C36
...
| **EP15** | Venta Asistida, Sustitutos y Agentes | **C26 (archivado)**, ~~C27~~ *(cortado 12 sep)*, **C30a (archivado 13 sep)**, **C30b (archivado 14 sep)** *(partidos el 13 sep)*, **C31 (archivado 16 sep)**, **C32a (en curso 20 sep)**, **C32b** *(partidos el 20 sep)*, C34, C36 | 🟠 parcial |
...
| **TOTAL PF** | | **45 fichas · 39 vivas** (5 anuladas, 1 cortada) — **33 archivadas, 6 pendientes** | |
