...
**Changes asociados:** C12 (hecho), C13 (hecho), C14 (hecho), C15 (hecho), C16 (hecho), C20 (hecho), C21 (hecho), **C22 (hecho)**, **C25** (`recalibrate-ranking-and-abstention` — **hecho**, abierto el 2026-09-11 y archivado el 2026-09-12; renombrado desde `add-business-signals-ranking`), **C25bis** (`clean-plain-fusion` — **pendiente**, prerrequisito duro C25 archivado)
