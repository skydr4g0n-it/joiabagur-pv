...
**Changes asociados:** C06a (hecho), C06b (hecho), C08 (hecho), C09 (hecho), C10 (hecho), C11 (hecho), C23, **FIX1** (`fix-enrichment-vocabulary-gaps`, fuera de la numeración C — **hecho**, abierto y ejecutado 2026-09-05; entró antes de que C24 etiquete)
