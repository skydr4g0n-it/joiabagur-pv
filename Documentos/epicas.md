...
**Changes asociados:** C06a (hecho), C06b (hecho), C08 (hecho), C09 (hecho), C10 (hecho), C11 (hecho), C23, **FIX1** (`fix-enrichment-vocabulary-gaps`, fuera de la numeración C — detrás de C22 y antes de que C24 etiquete)
...
**Changes asociados:** C12 (hecho), C13 (hecho), C14 (hecho), C15 (hecho), C16 (hecho), C20 (hecho), C21 (hecho), **C22 (en curso)**, C25
...
| **TOTAL PF** | | **42 fichas · 37 vivas** (5 anuladas) — **23 archivadas, 14 pendientes** | |
