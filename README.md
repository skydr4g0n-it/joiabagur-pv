...
- `ai-service/src/jbg_ai/retrieval/`: retriever vectorial C14 de `POST /v1/retrieval/products` (coseno `<=>` sobre HNSW, umbral de distancia, sobre-recuperación) y expansión de consulta C20 (diccionario de sinónimos en dos capas y CLI de medición). No lee nunca el esquema `public`.
