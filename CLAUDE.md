...
2026-09-22, **114 failures of 597 tests, across 15 of the 48 files** (113 of 595 on 2026-09-13; 118
of 482 on 2026-08-29 — the suite grew and the red did not). The method is identical to the backend's
...
the backend's — but enough that the count is not a signal. The one thing that is: **zero new names**.
